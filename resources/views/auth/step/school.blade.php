    ...
    <main class="relative w-full h-max-screen flex flex-col justify-evenly items-center bg-brand-white element-before">
      <div
        ...
        <form id="body" class="w-3-quarts flex flex-col justify-between items-center gap-5 sm-md-width h-md-sm"
          ...
          @csrf
          <div id="pagination" class="w-full flex justify-center items-center gap-5 sm-md-width"
            style="--rWidthValue:90vw">
            @for ($i = 1; $i <= 3; $i++)
              <div
          ...
          <div id="steps" class="w-3-quarts sm-md-width" style="--rWidthValue:100%">
            ...
            <div id="step" class="w-full hidden flex-col justify-evenly items-center gap-5">
              ...
              <div class="w-3-quarts flex justify-between items-center gap-5">
                <div class="w-full h-4 flex items-center p-10 gap-2 rounded-sm transition-all schoolname-box"
                  id="schoolNameBox">
                  <input type="text" class="w-full bg-transparent font-lg" name="school_name" id="schoolName"
                    aria-describedby="schoolName" />
                </div>
              </div>
              <div class="w-full flex justify-between items-center">
                <a id="backStep" class="text-dark font-xs cursor-pointer">
                  < Back </a>
                    <button id="nextStep"
            ...
            <div id="step" class="w-full hidden flex-col justify-evenly items-center gap-5">
              ...
              <div class="w-3-quarts flex items-center gap-5">
                <div id="inputBox"
                  class="w-full flex items-center bg-inputGrey gap-5 p-5 rounded-sm border border-primary">
                  <label for="email"><x-mail-icon /></label>
                  <input type="email" name="second_admin_email" id="secondaryAdminEmail"
