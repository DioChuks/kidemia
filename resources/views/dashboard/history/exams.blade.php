    ...
    <div class="h-max-screen sm-md-height">
      ...
      <div class="h-10p flex items-center pl-5">
        <a href="{{ route('show.user-dashboard') }}" class="flex items-center gap-5 cursor-pointer">
          <x-arrow-left-icon />
          <h1 class="text-dark">Your exam history</h1>
        </a>
      </div>
      <br>
      <div class="w-full flex flex-col gap-10 items-center justify-center">
        <div
          class="w-90p h-30 flex items-center justify-between gap-5 p-5 bg-gray rounded-md sm-flex-col sm-justify-content h-md-sm"
          style="--pos:space-evenly;--rH:100%;">
          <div class="w-40p h-70p flex flex-col justify-center gap-10">
            <div class="flex items-center gap-5 bg-white rounded-sm pl-1 pr-1"><img
                src="{{ asset('images/calendar.png') }}" alt="calendar"> Date: 24-10-2024</div>
            <div class="flex items-center gap-5 bg-white rounded-sm pl-1 pr-1"><img
                src="{{ asset('images/image 3.png') }}" alt="clock"> Time Used: 20 mins</div>
            <div class="flex items-center gap-5 bg-white rounded-sm pl-1 pr-1"><img
                src="{{ asset('images/meter.png') }}" alt="meter"> Average Time per second: 1min per question</div>
          </div>
          <div class="h-full">
            <div class="w-30 h-80p flex flex-col items-center gap-5">
              <x-pie-percent class="w-10 h-10 p-5 bg-conic-blue font-xl" progress="45" textSize="text-18"
                whitespace-bg='bg-gray' bg-type='bg-light-blue' />

              <h2 class="text-dark">You got 15/20 overall</h2>
          ...
          <div class="w-30 h-95p bg-white top-right-radius bottom-right-radius p-5">
            <h4>4 Subjects touched on</h4>
            <br>
            <div class="w-full flex flex-col gap-5 h-70p">
              <div class="w-full flex items-center justify-between border-bottom">
                <h6 class="text-gray">Science</h6>
                <span><span class="text-green font-lg">6</span>/10</span>
              </div>
              <div class="w-full flex items-center justify-between border-bottom">
                <h6 class="text-gray">Mathematics</h6>
                <span><span class="text-green font-lg">6</span>/10</span>
              </div>
              <div class="w-full flex items-center justify-between border-bottom">
                <h6 class="text-gray">Agriculture</h6>
                <span><span class="text-green font-lg">6</span>/10</span>
              </div>
              <div class="w-full flex items-center justify-between border-bottom">
                <h6 class="text-gray">English Language</h6>
                <span><span class="text-green font-lg">6</span>/10</span>
              </div>
            </div>
