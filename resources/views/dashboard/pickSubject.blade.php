   ...
   <div class="h-auto bg-brand-white">
    <div class="flex justify-between gap-5 p-20">
     ...
     <div class="flex flex-col items-center gap-5">
      ...
      <a class="w-3-quarts flex items-center justify-center p-20 bg-green text-white rounded-sm transform-scale-d5-hover transition-all" href="{{ route('pick.topic', ['subject' => 'all', 'type' => $type]) }}" style="--w:100%">
