...
<body class="bg-brand-white">
  ...
  <div id="app" class="hidden">
    <div class="h-max-screen">
            ...
            <div class="h-15p flex justify-between items-center gap-5">
              ...
              <div class="flex items-center gap-5">
                ...
                <button id="openEditBtn"
                  class="flex items-center gap-5 p-10 border-none outline-none bg-primary-10 bg-hover text-primary rounded-sm cursor-pointer transition-all"
      ...
      {{-- edit subject modal --}}
      <div
        class="fixed hidden z-1 left-0 top-0 w-full h-full justify-center items-center overflow-auto bg-semi-black transition-all editSubjectModal"
        id="editModal">
        <form
          ...
          method="post" action="{{ route('admin.update.subject', $subject) }}">
          @csrf
          <span
            ...
            id="closeEditBtn" style="--textColor:crimson;">&times;</span>
          <h1 class="text-dark sm-text-value" style="--textSmVal:13px;">
            Edit <span class="text-secondary">Subject</span></h1>
          ...
          <div class="w-3-quarts flex items-center justify-between gap-5">
            ...
            <a href="{{ route('admin.add-question') }}" class="w-half p-10 text-center rounded-sm bg-primary text-white cursor-pointer">Add Question</a>
          </div>
        </form>
      </div>
      {{-- add subject modal --}}
      <div
        class="fixed hidden z-1 left-0 top-0 w-full h-full justify-center items-center overflow-auto bg-semi-black transition-all addSubjectModal"
        id="customModal">
        <form
          class="relative w-half h-3-quarts flex flex-col items-center justify-evenly gap-5 bg-brand-white p-10 rounded-md modal-content animate-slideDown"
  ...
  <script>
    ...
    // When the user clicks on <span> (x), close the editModal
