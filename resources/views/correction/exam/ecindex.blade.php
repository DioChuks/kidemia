        ...
        <div class="w-half h-full flex flex-col justify-evenly bg-brand-white">
          <div class="w-full mx-auto flex flex-col justify-center items-center">
            <div class="w-full flex flex-col justify-center gap-10 p-5">
              <div class="inline-flex items-start gap-5" id="examSubjects">
                {{-- the subjects written go here --}}
                <span class="exam-subject p-5 text-center border border-dark rounded-xs bg-light-blue text-white cursor-pointer">English Language</span>
                <span class="exam-subject p-5 text-center border border-dark rounded-xs cursor-pointer">Science</span>
                <span class="exam-subject p-5 text-center border border-dark rounded-xs bg-light-blue text-white cursor-pointer">Home Economics</span>
              </div>
                ...
                @for ($i = 1; $i <= 20; $i++)
                  <div class="mx-3 qno">
                    ...
                    <label for="questionRadio-{{ $i }}"
                      class="w-3 h-3 inline-flex items-center justify-center bg-green text-white rounded-xs cursor-pointer transition-all input-label">{{ $i }}</label>
                  </div>
                @endfor
              </div>
            </div>
